...
class RidgeRegressionModel(SKLearnModelsABC):
    def __init__(self, alpha=1.0, fit_intercept=True, normalize=False, max_iter=None,
                  tol=0.001):
        self.model = Ridge(alpha=alpha, fit_intercept=fit_intercept, normalize=normalize,
...
class ElasticNetRegressionModel(SKLearnModelsABC):
    def __init__(self, alpha=1.0, l1_ratio=0.5, fit_intercept=True, normalize=False, max_iter=None,
                  tol=0.001):
        self.model = ElasticNet(alpha=alpha, l1_ratio=l1_ratio, fit_intercept=fit_intercept, normalize=normalize,
                                max_iter=max_iter, tol=tol)
...
class SGDClassifierModel(SKLearnModelsABC):
    def __init__(self, loss='hinge', penalty='l2', alpha=0.0001, l1_ratio=0.15, fit_intercept=True,
        ...
        self.model = SGDClassifier(loss=loss, penalty=penalty, alpha=alpha, l1_ratio=l1_ratio, fit_intercept=fit_intercept,
                 max_iter=max_iter, tol=tol, shuffle=shuffle, verbose=verbose, epsilon=epsilon,
                 n_jobs=n_jobs, random_state=random_state, learning_rate=learning_rate, eta0=eta0,
                 power_t=power_t, early_stopping=early_stopping, validation_fraction=validation_fraction,
...
class SVCModel(SKLearnModelsABC):
    def __init__(self, C=1.0, kernel='rbf', degree=3, gamma='scale', coef0=0.0,
        ...
        self.model = SVC(C=C, kernel=kernel, degree=degree, gamma=gamma, coef0=coef0,
...
class KmeansModel(SKLearnModelsABC):
    def __init__(self, n_clusters=8, init='k-means++', max_iter=300, n_init=10, random_state=None):
        self.model = KMeans(n_clusters=n_clusters, init=init, max_iter=max_iter, n_init=n_init, random_state=random_state)
...
class GaussianmixtureModel(SKLearnModelsABC):
    def __init__(self, n_components=1, covariance_type='full', tol=0.001, reg_covar=1e-06, max_iter=100,
                 n_init=1, init_params='kmeans', random_state=None, warm_start=False, verbose=0,
                 verbose_interval=10):
        self.model = GaussianMixture(n_components=n_components, covariance_type=covariance_type, tol=tol, reg_covar=reg_covar, max_iter=max_iter,
                 n_init=n_init, init_params=init_params, random_state=random_state, warm_start=warm_start, verbose=verbose, verbose_interval=verbose_interval)